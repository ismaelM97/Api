...
def Tweet():
    data=[]
    for tweet in tweepy.Cursor(api.search,q="covid-19",geocode="-0.749907,-78.97,450km", tweet_mode="extended",lang="es").items(5):
      dat=[]
